...
<body>
    ...
    <form class="form" action="${pageContext.request.contextPath}/registerServlet" method="post">
        ...
        <div class="field">
            ...
            <input autocomplete="off" placeholder="用户名（5到12位，仅含数字、字母、下划线）" class="input-field" name="username" type="text">
        </div>
        <div class="field">
            <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                viewBox="0 0 16 16">
            ...
            <input placeholder="密码 （至少5位，仅含数字、字母、下划线）" class="input-field" type="password" name="password">
        </div>
        <div class="field">
            <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                viewBox="0 0 16 16">
            ...
            <input placeholder="确认密码" class="input-field" type="password" name="confirm">
        </div>
        <div class="btn">
