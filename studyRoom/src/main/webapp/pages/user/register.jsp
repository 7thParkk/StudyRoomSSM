...
<body>
    ...
    <form class="form" action="/register" method="post">
        <p id="heading">注册</p>
        <div id="errorMsg">
            ${not empty requestScope.get("msg") ? requestScope.get("msg") : "请输入用户名与密码"}
        </div>
        <div class="field">
            ...
            <input autocomplete="off" placeholder="用户名（5到12位，仅含数字、字母、下划线）" class="input-field" name="userAccount" type="text">
        </div>
        <div class="field">
            <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                viewBox="0 0 16 16">
            ...
            <input placeholder="密码 （至少5位，仅含数字、字母、下划线）" class="input-field" type="password" name="userPassword">
        </div>
        <div class="field">
            <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                viewBox="0 0 16 16">
            ...
            <input placeholder="确认密码" class="input-field" type="password" name="confirmPassword">
        </div>
        <div class="btn">
            <button class="button2" type="submit">注册</button>
            <button class="button3">返回登录</button>
        </div>
    </form>
</body>
